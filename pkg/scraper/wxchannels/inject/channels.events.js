...
(function () {
  ...
  // 注意：DOMContentLoaded / DOMContentBeforeUnLoaded / WindowLoaded /
  // WindowUnLoaded 四个通用 DOM 生命周期事件已在 eventbus.js 中定义，
  // 这里不再重复。
  // OfficialAccountRefresh 已在 eventbus.js 中定义，供 wxmp scraper 使用。

  // 注册事件名到 WXE.Events，保持向后兼容（已有脚本通过 WXE.Events.xxx 引用）
